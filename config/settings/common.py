...
ROOT_DIR = environ.Path(__file__) - 3  # (tasklist/config/settings/common.py - 3 = tasklist/)
APPS_DIR = ROOT_DIR.path('tasklist')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'tasklist.contrib.sites.migrations'
}
...
ACCOUNT_ADAPTER = 'tasklist.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'tasklist.users.adapters.SocialAccountAdapter'
